...
/**
 * @extends Factory<EntidadeExterna>
 */
class EntidadeExternaFactory extends Factory
{
    protected $model = EntidadeExterna::class;
    ...
    /**
     * Estado: entidade apenas com nome e tipo (mínimo obrigatório).
     */
