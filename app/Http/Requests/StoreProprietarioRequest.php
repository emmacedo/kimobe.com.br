...
class StoreProprietarioRequest extends FormRequest
{
    ...
    /**
     * Sanitiza máscaras antes de validar.
     */
    ...
    {
        // O proprietario é resolvido por route binding em update; ignora seu user_id no unique.
        $userIdToIgnore = $this->route('proprietario')?->user_id;
