...
/**
 * Formulário compartilhado entre Proprietário e Inquilino — ambos são User+Vinculo
 * com mesmos campos. O título e o texto do aviso de placeholder customizam o contexto.
 */
...
export const dadosIniciaisPessoa: PessoaFormData = {
    name: '',
    tipo_pessoa: 'pf',
    documento: '',
    telefone: '',
...
type Props = {
    dados: PessoaFormData;
    titulo: string;
    avisoEmailTexto: string;
    errors: Record<string, string>;
    processing: boolean;
    onSubmit: (dados: PessoaFormData) => void;
...
export function PessoaForm({
    ...
    const [form, setForm] = useState<PessoaFormData>(dados);
    ...
    function setField<K extends keyof PessoaFormData>(key: K, value: PessoaFormData[K]) {
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-4">
            <div className="rounded-[10px] border border-[#D8DCDA] bg-white p-5">
                <h2 className="mb-4 text-sm font-medium text-[#1E2D30]">{titulo}</h2>
